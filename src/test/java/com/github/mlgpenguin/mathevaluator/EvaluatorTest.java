...
public class EvaluatorTest {
    ...
    public void testLongNumbers() {
        String num = "";
        assertThrows(Util.InvalidSyntaxException.class, () -> eval(num +"*3"));
        assertThrows(Util.InvalidSyntaxException.class, () -> eval("333.123456789123456789*3"));
    }
}